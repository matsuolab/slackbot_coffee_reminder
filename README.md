...
```bash
/barista register 2024-06 @user1 @user2 @user3
```

- 指定した月の平日に指定したユーザーが均等に割り当てられます
- 既存の割り当てがある場合は上書きされます
...
- 月始めに `/barista register` で当番登録するのがおすすめです
